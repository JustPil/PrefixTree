...
public class ArrayBasedNode {
    private char letter;
    private final int ALPHABET = 26;
    private final ArrayBasedNode[] childNodes = new ArrayBasedNode[ALPHABET];
     ...
     */
    public ArrayBasedNode[] getChildNodes() {
        return childNodes;
    }
    ...
    public void addChildNodes(char c) {
        ...
        childNodes[c - 'a'] = new ArrayBasedNode(c);
    }
}
